...
@section('content')
    ...
    <section class="customer_form" id="customer_form">
        <div class="container py-5">
            ...
            <form method="post" enctype="" class="" action="">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="form-group row mb-lg-5">
                            <label for="customer" class="col-sm-2 col-form-label">客戶姓名</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputCustomer" value="" id="customer">
                            </div>
                        </div>
                        <div class="form-group row mb-lg-5">
                            <label for="telephone" class="col-sm-2 col-form-label">家用電話</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputTel" value="" id="telephone">
                            </div>
                        </div>
                        <div class="form-group row mb-lg-5">
                            <label for="cellphone" class="col-sm-2 col-form-label">行動電話</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputPhone" value="" id="cellphone">
                            </div>
                        </div>
                        <div class="form-group row mb-lg-5">
                            <label for="email" class="col-sm-2 col-form-label">E-mail</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputEmail" value="" id="email">
                            </div>
                        </div>
                        <div class="form-group row mb-lg-5">
                            <label for="service" class="col-sm-2 col-form-label">服務類型</label>
                            <div class="col-sm-10">
                                <select name="service" id="service">
                                    <option value="">服務1</option>
                                    <option value="">服務2</option>
                                    <option value="">服務3</option>
                                    <option value="">服務4</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-lg-5">
                            <label for="title" class="col-sm-2 col-form-label">主旨</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputTitle" value="" id="title">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Content" class="col-sm-2 col-form-label">內文</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="inputContent" id="inputContent" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="row py-5">
