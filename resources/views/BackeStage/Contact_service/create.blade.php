...
<div class="container">
    ...
    <form class = "contact_info d-flex flex-wrap justify-content-end    "  action = "/admin/ContactService/ " method = "POST">
        @csrf
        ...
        <div class = "d-flex justify-content-between mb-3 "style = "width:100%;">
            ...
            <input type="text" class = "col-7" name = "service_name"  required>
        </div>
